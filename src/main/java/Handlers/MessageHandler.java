...
public class MessageHandler {
    ...
    public String help() {
        ...
        if (args.equals("")) {
            ...
            builder.append(Constants.PREFIX_INDENT + Utility.getCommandInfo("help", guildConfig) + "\n");
            ...
            builder.append(Constants.PREFIX_INDENT + "Please DM " + message.getClient().getOurUser().mention() + " or" +
                    "head over to \n" + Constants.PREFIX_INDENT + "https://discord.gg/XSyQQrR.");
        } else {
            ...
            for (String s : types) {
                if (args.equalsIgnoreCase(s)) {
                    ...
                    for (Method m : methods) {
                        if (m.isAnnotationPresent(CommandAnnotation.class)) {
                            ...
                            if (anno.type().equalsIgnoreCase(s)) {
                                commands.add(Constants.PREFIX_INDENT + guildConfig.getPrefixCommand() + anno.name() + "\n");
                            }
                        }
                    }
                    ...
                    builder.append(Constants.PREFIX_INDENT + Utility.getCommandInfo("info", guildConfig));
                }
            }
            if (!isFound) {
    ...
    public String updateAvatar() {
        if (author.getID().equals(Globals.creatorID)) {
            ...
            file.append(Constants.DIRECTORY_GLOBAL_IMAGES + "avatarForDay_" + 1);
            file.append(".png");
